...
function funCMD.inv(id)
	...
	if num_rank.v+1 < 9 then
		...
		sampAddChatMessage("{FFFFFF}[{EE4848}OnlineRpHelper{FFFFFF}]: Используйте команду /inv [id игрока].", 0xEE4848)
		end
end
function funCMD.unv(text)
	...
	if num_rank.v+1 < 9 then
		...
		sampAddChatMessage("{FFFFFF}[{EE4848}OnlineRpHelper{FFFFFF}]: Используйте команду /unv [id игрока] [причина].", 0xEE4848)
		end
end
...
function funCMD.expel(par)
	...
	sampAddChatMessage("{FFFFFF}[{EE4848}OnlineRpHelper{FFFFFF}]: Используйте команду /exp [id игрока] [Причина].", 0xEE4848)
	end
end
